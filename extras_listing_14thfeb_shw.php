								...
								if($data['itemChoiceInfo'][$i]['choiceCategory']=="Extras")
								{
			                            $html.='<li>
			                                <div class="inputRadio">
			                                    <input type="checkbox" name="extraItem" id="'.$i.'Item" data-role="none" value="'.$data['itemChoiceInfo'][$i]['choicePrice'].'"/>
			                 ...
			                 else
			                 {
			                 	if($data['itemChoiceInfo'][$i]['choiceCategory']=="Extras")
								{
									...
									$explode=explode(",",$selected_items);
										 ...
										 $html.='<li>
			                               <div class="inputRadio">
			                                    <input type="checkbox" name="extraItem" id="'.$i.'Item" ';if(in_array($i.'Item', $explode)){ $html.=' checked '; } else { $html.=' '; } $html.=' data-role="none" value="'.$data['itemChoiceInfo'][$i]['choicePrice'].'"/>
			                                    <label for="'.$i.'Item">'.$data['itemChoiceInfo'][$i]['choiceName'].' ( $'.$data['itemChoiceInfo'][$i]['choicePrice'].' )</label>
			                                </div>
			                            </li>';
