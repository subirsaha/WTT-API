								...
								$id_item=$i.'Item'.$choicecat;
		                            $html.='<li>
			                                <div class="inputRadio">
			                                    <input type="checkbox" name="extraItem" id="'.$id_item.'"';if(in_array($id_item, $selectidsarr)){ $html.=' checked '; } else { $html.=' '; } $html.='data-role="none" value="'.$id_item.'####'.$data['itemChoiceInfo'][$i]['id'].'####'.$data['itemChoiceInfo'][$i]['choicePrice'].'####'.$data['itemChoiceInfo'][$i]['choiceCategory'].'####'.$data['itemChoiceInfo'][$i]['choiceName'].'####'.$data['itemChoiceInfo'][$i]['choiceGroup'].'"/>
