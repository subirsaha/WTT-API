				...
				<div class="inner-content">
					<div class="contactInfoHeader">	
						...
						else
						{
							...
							<span class="icon-block order right"><b>$'.$_REQUEST["minorderamt"].' minimum</b></span></div>';
						}
						...
						<table id="basketpgtbl" data-role="table" data-mode="columntoggle" class="ui-body-d ui-shadow table-stripe table-stroke ui-responsive ui-table" data-column-btn-theme="b" style="width:100%" >
							...
							for ($i=0; $i < count($explode); $i++) {
								...
								else
								{
									...
									$html .='<td>
									<p class="split-text" onclick="edit_item(\'' . $expld[6] . '\',\'' . $expld[5] . '\',\'' . $expld[4] . '\',\'' . $expld[3] . '\',\'' . $choice_limit . '\',\'' . $expld[0] . '\');">
										'.$expld[4].' <small>';if($string!="" || $string!="undefined"){ $html .='+'; }$html .=$expld[1]; $html .='</small>
									</p></td>';
									$pricestr='';
									$price=0;
