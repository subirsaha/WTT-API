							...
							<div class="search-result-box">
								...
								<div class="right-small-box">
									<h5 id="set_price">$'.$price.'</h5>
									 <input type="hidden" id="main_price_actual_value" name="main_price_actual_value" value="'.$price.'" />
								</div>
							</div>
						</div>
