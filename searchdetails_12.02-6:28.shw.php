...
savename(\'' . $data2['locations'][0]['items'][$j]['itemname'] . '\',\'' . $data2['locations'][0]['items'][$j]['itemprice'] . '\',\'' . $data2['locations'][0]['items'][$j]['id'] . '\',\'' . $data2['locations'][0]['items'][$j]['choiceLimit'] . '\',\'' . $data2['locations'][0]['items'][$j]['itemdesc'] . '\',\'' . $rp . '\',\'' . $data['businessInfo'][$i]['businessName'] . '\');"><div class="search-result-box">
