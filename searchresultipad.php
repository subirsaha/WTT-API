...
//echo "https://whatthetrucks.com/Innovommerce/rest/businessinfolist/listfoodtrucks?LATLONG=".$lat.",".$long."&name=".$keywrd."";
 ...
 $rp="";
	...
	$html .= '<div class="bar bar-default">
						<a  onClick="gotoDetailsRes(\'' . $data['businessInfo'][$i]['id'] . '\',\'' . $lat . '\',\'' . $long . '\',\'' . $busId . '\',\'' . addslashes($data['businessInfo'][$i]['businessName']) . '\',\'' . addslashes($lcttn). '\',\'' . $time . '\',\'' . $data['businessInfo'][$i]['pickupTime'] . '\',\'' . $data['businessInfo'][$i]['minOrderAmt'] . '\',\'' . $data['businessInfo'][$i]['deliveryCharge'] . '\',\'' . $data['businessInfo'][$i]['deliveryMethod'] . '\',\'' . $data['businessInfo'][$i]['deliveryTime'] . '\',\'' . $data['businessInfo'][$i]['minDeliveryOrd'] . '\',\'' . $data['businessInfo'][$i]['locations'][0]['id'] . '\',\'' . $data['businessInfo'][$i]['taxRate'] . '\',\'' . $data['businessInfo'][$i]['tandcversion'] . '\',\'' . $data['businessInfo'][$i]['tandc'] . '\',\'' . $rp . '\',\'' . $add_locid . '\',\'' . addslashes($lcttn) . '\')" ><div class="search-result-box" >
							<img src="img/whattruck.png" width="77" height="77" alt="" class="img-thumbnail img-left" />
							<h3>'.$data['businessInfo'][$i]['businessName'].'</h3>
							<div class="inline-icon"><span class="icon-block location">'.$lcttn.'</span></div>
							...
							else
							{
								...
								if($data['businessInfo'][$i]['activeWithDookans']== 0){
								$html .='<span class="icon-block order">Accepts WTT Orders</span>';
