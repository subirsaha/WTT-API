...
$facebookaddrs = $_REQUEST["facebookaddrs"];
$facebookemail = $_REQUEST["facebookemail"];
$facebookuname = $_REQUEST["facebookuname"];

//echo $cardtype.'@@'.$cardname.'@@'.$cardNumber;
...
$httpRequest = curl_init();
    ...
    $url = "http://whatthetrucks.com:8080/Innovommerce/rest/customer/createCustomerPaymentProfile";
  ...
  curl_close($httpRequest);
                ...
                $data = array
                        (
                        'userName'=>$facebookuname,
                        'address'=>$facebookaddrs,
                        'email'=>$facebookemail, 
                        );  
                    ...
                    $url = "https://dookansserver.com/Innovommerce/rest/customer/createCustomer";
                    curl_setopt($httpRequest, CURLOPT_URL, $url);
                    ...
                    //echo '<pre>';print_r($returnHeader);echo '</pre>';
  ...
  // echo $explode_string['1'];
   ...
   $return_code=$json_decode["returnCode"];
...
$html = '<div class="inner-content">
                ...
                //echo $html;
                //echo $returnHeader1;
                echo $returnHeader1.'@@@@@@@@'.$return_code;
