...
//echo $item_id.','.$choiceLimit.','.$itemname.','.$price.','.$description.','.$quantity;
...
$html.='<div class="contactInfoHeader">	
						<div class="ui-bar ui-bar-white">
							<h2>'.$itemname.' <span class="right" id="set_price">$'.$price.'</span></h2>
							<p>'.$description.'</p>
						</div>';
						...
						$html.='<div class="ui-bar ui-bar-pulple">
							<h2>Item Options</h2>
						</div>
					</div>
