...
$html = '
				<div class="inner-content">
						...
						<table id="basketpgtbl" data-role="table" data-mode="columntoggle" class="ui-body-d ui-shadow table-stripe table-stroke ui-responsive ui-table" data-column-btn-theme="b" style="width:100%" >
							<thead>
								<tr class="ui-bar-d ui-bar-blue">
									<th style="padding-left:15px;">QTY</th>
									<th>ITEM</th>
									<th>PRICE</th>
									<th></th>
							...
							for ($i=0; $i < count($explode); $i++) {
								...
								{
									$html .='<td style="padding-left:15px;">'.$expld[0].'</td>';
								}
									...
									$html.='<td><a onclick="remove_item_full(\'' . $i . '\',\'' . $string . '\');" class="delete"></a></td>
									</tr>';
									}
					...
					<div class="total">
						<h3>Total: <span id="total_pricehhh">$'.number_format($tot_price,2).'</span></h3>
					</div>
					<div class="addItem">
