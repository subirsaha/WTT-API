...
$html .= '<div class="inner-content">
					...
					<div class="total">
						...
						<p>
							...
							<span class="right">$ <input type="text" id="tipbox" onkeypress="return (event.charCode >= 48 && event.charCode <= 57) || (event.charCode == 46)" onkeyup="updatetipvalue('.this.')" data-role="none" class="tipBox"/></span>
						</p>
						<p>
					...
					{
						$html .= '<div class="bar bar-default">
								<a onclick="add_contact()" class="addressBar" id="addnewcnct">
					...
					{
						$html .= '<div class="bar bar-default">
								<a onclick="add_payment()" class="addressBar" id="addnewpmt">
					...
					{
						$html .= '<div class="bar bar-default">
								<a class="ui-link" onclick="changepickup()" id="show_pick">Pickup Time : Now</a>
							</div>';
					}
					else
					{
