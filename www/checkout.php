...
$html .= '<div class="inner-content">
					...
					<div class="total">
						...
						<p>
							...
							<span class="right">$ <input type="text" pattern="\d*" id="tipbox" onkeypress="return (event.charCode >= 48 && event.charCode <= 57) || (event.charCode == 46)" onkeyup="updatetipvalue('.this.')" data-role="none" class="tipBox"/></span>
						</p>
						<p>
							<span class="left-label"><b>Tax:</b></span>
							<span class="right" id="tax_price">$'.round($taxrate,2).'</span>
						</p>
					...
					if($final_strnew_pay=="" || $final_strnew_pay=="undefined" || $final_strnew_pay=="==" || $explode_string_payment[0]=="**** **** **** '" || $explode_string_payment[0]=="'")
					{
					...
					{
						$html .= '<div class="bar bar-default">
								<a class="ui-link" onclick="changepickup()" id="show_pick"></span></a>
							</div>';
					}
