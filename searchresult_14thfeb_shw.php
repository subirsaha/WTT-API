...
$cnt=strlen($strt);
 ...
 $rp="";
	...
	$html .= '<div class="bar bar-default">
						<a  onClick="gotoDetailsRes(\'' . $data['businessInfo'][$i]['id'] . '\',\'' . $lat . '\',\'' . $long . '\',\'' . $busId . '\',\'' . $data['businessInfo'][$i]['businessName'] . '\',\'' . $lcttn . '\',\'' . $time . '\',\'' . $data['businessInfo'][$i]['pickupTime'] . '\',\'' . $data['businessInfo'][$i]['minOrderAmt'] . '\',\'' . $data['businessInfo'][$i]['deliveryCharge'] . '\',\'' . $data['businessInfo'][$i]['deliveryMethod'] . '\',\'' . $data['businessInfo'][$i]['deliveryTime'] . '\',\'' . $data['businessInfo'][$i]['minDeliveryOrd'] . '\',\'' . $data['businessInfo'][$i]['locations'][0]['id'] . '\',\'' . $data['businessInfo'][$i]['taxRate'] . '\',\'' . $data['businessInfo'][$i]['tandcversion'] . '\',\'' . $data['businessInfo'][$i]['tandc'] . '\',\'' . $rp . '\',\'' . $add_locid . '\',\'' . $lcttn . '\')" ><div class="search-result-box" >
