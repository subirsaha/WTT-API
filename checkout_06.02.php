...
$html = '<div class="inner-content">
					...
					<div class="fullWidth">
						<table data-role="table" data-mode="columntoggle" class="ui-body-d ui-shadow table-stripe ui-responsive" data-column-btn-theme="b" style="width:100%">
							<thead>
							...
							<tbody>';
								...
								$html .= '<tr>
									...
									<td>$'.$expld[5].'</td>
									<td><a onclick="remove_item(\'' . $i . '\',\'' . $string . '\');" class="delete"></a></td>
									</tr>';
