	...
	$time_in_12_hour_format_start = date("h:ia", strtotime($data['businessInfo'][$i]['locations'][0]['locationHours'][0]['startTime']));
		...
		$html .='<div class="bar">
						<div class="search-result-box">
							...
							$html .='<div class="right-small-box">
					...
					if($rp == "yes"){
						$string_length=strlen($data2['locations'][0]['items'][$j]['itemdesc']);

							// echo "arunima";

								$html .= '<div class="bar bar-default">
							<a href="#" class="ui-link" onclick="
savename(\'' . str_replace("'", "", $data2['locations'][0]['items'][$j]['itemname']) . '\',\'' . number_format($data2['locations'][0]['items'][$j]['itemprice'], 2) . '\',\'' . $data2['locations'][0]['items'][$j]['id'] . '\',\'' . $data2['locations'][0]['items'][$j]['choiceLimit'] . '\',\'' . $data2['locations'][0]['items'][$j]['itemdesc'] . '\',\'' . $rp . '\',\'' . $data['businessInfo'][$i]['businessName'] . '\');"><div class="search-result-box">
								<h4>'.$data2['locations'][0]['items'][$j]['itemname'].'</h4>';
								if($string_length>83)
								{
									$html .= '<p>'.substr($data2['locations'][0]['items'][$j]['itemdesc'], 0, 83).'...</p>';
								}
								else
								{
								 	$html .= '<p>'.$data2['locations'][0]['items'][$j]['itemdesc'].'</p>';
								 }
								$html .= '<div class="right-small-box">
			...
			$html .= '<div class="bar bar-default">
										<a href="#truckdetailsPopupNot" class="ui-link" data-rel="popup" data-position-to="window" data-transition="pop"><div class="search-result-box">
											<h4>'.$data2['locations'][0]['items'][$j]['itemname'].'</h4>';
											if($string_length>83)
											{
												$html .= '<p>'.substr($data2['locations'][0]['items'][$j]['itemdesc'], 0, 83).'...</p>';
					...
					if($rp == "yes"){
						...
						$string_length=strlen($data2['locations']['items'][$j]['itemdesc']);
							...
							// echo "arunima";
								...
								$html .= '<div class="bar bar-default">
							<a href="#" class="ui-link" onclick="
savename(\'' . str_replace("'", "", $data2['locations']['items'][$j]['itemname']) . '\',\'' . number_format($data2['locations']['items'][$j]['itemprice'], 2) . '\',\'' . $data2['locations']['items'][$j]['id'] . '\',\'' . $data2['locations']['items'][$j]['choiceLimit'] . '\',\'' . $data2['locations']['items'][$j]['itemdesc'] . '\',\'' . $rp . '\',\'' . $data['businessInfo'][$i]['businessName'] . '\');"><div class="search-result-box">
